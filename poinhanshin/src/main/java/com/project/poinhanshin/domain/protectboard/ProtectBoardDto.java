...
public class ProtectBoardDto {
     ...
     boolean protectboard__ani_category;  // 강아지 0 or 고양이 1
     ...
     public ProtectBoardDto(Integer protectboard_userno, Integer protectboardno, String protectboard_content, byte[] protectboard_imagepath, String breeds, boolean protectboard__ani_category, Date protectboard_reg_date, boolean protectstatus, Date deadline) {
          ...
          this.breeds = breeds;
          this.protectboard__ani_category = protectboard__ani_category;
